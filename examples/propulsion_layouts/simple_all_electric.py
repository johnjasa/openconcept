...
class AllElectricPropulsionSystemCompressible(Group):
    ...
    def setup(self):
        ...
        dvlist = [['ac|propulsion|motor|rating', 'motor1_rating', 850, 'hp'],
...
class AllElectricPropulsionSystem(Group):
    ...
    def setup(self):
        ...
        self.add_subsystem('hx',HXGroup(num_nodes=nn),promotes_inputs=[('T_in_cold','fltcond|T'),('rho_cold','fltcond|rho')])
