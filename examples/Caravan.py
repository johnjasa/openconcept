...
from openmdao.api import DirectSolver, SqliteRecorder,IndepVarComp,NewtonSolver,BoundsEnforceLS, LinearBlockGS
...
if __name__ == "__main__":
    ...
    # prob['descent.throttle'] = np.ones((num_nodes))*0.2

    # .check_partials(includes=['*cruise*'],compact_print=True)
    prob.run_model()
    # prob.check_partials(compact_print=True,includes=['*cruise*'])
