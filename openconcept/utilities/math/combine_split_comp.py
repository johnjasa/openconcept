...
class VectorConcatenateComp(ExplicitComponent):
    ...
    def add_output(self):
        ...
        """
        raise NotImplementedError('Use add_relation method, not add_output method'
                                  'to create an concatenate relation')
    ...
    def setup(self):
        ...
        for (output_name, input_names, vec_sizes, length, val,
            ...
            super(VectorConcatenateComp, self).add_output(output_name, val,
                                                          shape=output_shape, **kwargs)
    ...
    def setup(self):
        ...
        for (output_names, input_name, vec_sizes, length, val,
            ...
            for i, output_name in enumerate(output_names):
                ...
                super(VectorSplitComp, self).add_output(output_name, val,
                                                        shape=output_shape, **kwargs)
                if i == 0:
                    start_idx = 0
                else:
